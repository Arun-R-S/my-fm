...
let App = class {
  ...
  componentDidLoad() {
    ...
    {
      rIC( /*#__PURE__*/(0,L_Ionic_Angular_Projects_my_fm_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        ...
        if (!_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('_testing')) {
          __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_tap-click-a895802b_js").then(__webpack_require__.bind(__webpack_require__, /*! ./tap-click-a895802b.js */ 3800)).then(module => module.startTapClick(_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__.c));
        }

        if (_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('statusTap', isHybrid)) {
          __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_status-tap-c10ad309_js").then(__webpack_require__.bind(__webpack_require__, /*! ./status-tap-c10ad309.js */ 4819)).then(module => module.startStatusTap());
        }

        if (_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('inputShims', needInputShims())) {
          __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_input-shims-61232da0_js").then(__webpack_require__.bind(__webpack_require__, /*! ./input-shims-61232da0.js */ 4265)).then(module => module.startInputShims(_ionic_global_a049bcbf_js__WEBPACK_IMPORTED_MODULE_2__.c));
        }

        const hardwareBackButtonModule = yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./hardware-back-button-ace6a71b.js */ 3279));
...
let Footer = class {
  constructor(hostRef) {
    ...
    this.setupFadeFooter = /*#__PURE__*/function () {
      var _ref2 = (0,L_Ionic_Angular_Projects_my_fm_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl) {
        if (!contentEl) {
...
let Header = class {
  constructor(hostRef) {
    ...
    this.setupFadeHeader = /*#__PURE__*/function () {
      var _ref3 = (0,L_Ionic_Angular_Projects_my_fm_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl, condenseHeader) {
        if (!contentEl) {
