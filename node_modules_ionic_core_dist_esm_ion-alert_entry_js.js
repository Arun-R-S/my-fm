...
/* harmony import */ var _button_active_767ae7c7_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./button-active-767ae7c7.js */ 1821);
...
let Alert = class {
   ...
   */
  present() {
    return (0,_overlays_89ee00ba_js__WEBPACK_IMPORTED_MODULE_3__.d)(this, 'alertEnter', iosEnterAnimation, mdEnterAnimation);
  }
  /**
   ...
   */
  dismiss(data, role) {
    return (0,_overlays_89ee00ba_js__WEBPACK_IMPORTED_MODULE_3__.f)(this, data, role, 'alertLeave', iosLeaveAnimation, mdLeaveAnimation);
  }
  /**
   * Returns a promise that resolves when the alert did dismiss.
   */
  onDidDismiss() {
    return (0,_overlays_89ee00ba_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionAlertDidDismiss');
  }
  /**
   * Returns a promise that resolves when the alert will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_89ee00ba_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionAlertWillDismiss');
  }
  rbClick(selectedInput) {
    ...
    (0,_overlays_89ee00ba_js__WEBPACK_IMPORTED_MODULE_3__.s)(selectedInput.handler, selectedInput);
  ...
  callButtonHandler(button, data) {
    if (button && button.handler) {
      ...
      const returnData = (0,_overlays_89ee00ba_js__WEBPACK_IMPORTED_MODULE_3__.s)(button.handler, data);
      if (returnData === false) {
