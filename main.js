...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.NgModule)({
        ...
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_7__.BrowserModule,
            ...
            _app_routing_module__WEBPACK_IMPORTED_MODULE_1__.AppRoutingModule, _angular_forms__WEBPACK_IMPORTED_MODULE_9__.ReactiveFormsModule, _angular_router__WEBPACK_IMPORTED_MODULE_10__.RouterModule, _angular_service_worker__WEBPACK_IMPORTED_MODULE_11__.ServiceWorkerModule.register('ngsw-worker.js', {
...
/* harmony import */ var _service_audio_service_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../service/audio-service.component */ 2170);
...
let RadioChannelsPage = class RadioChannelsPage {
    ...
    ngAfterViewInit() {
        if (localStorage.getItem('vol') == null) {
            jquery__WEBPACK_IMPORTED_MODULE_2__('#volume').val('1');
        }
        else {
            //console.log(Number(localStorage.getItem('vol')) * 200);
            jquery__WEBPACK_IMPORTED_MODULE_2__('#volume').val(Number(localStorage.getItem('vol')) * this.volumeConvert);
        }
    }
...
RadioChannelsPage.ctorParameters = () => [
    { type: _service_audio_service_component__WEBPACK_IMPORTED_MODULE_3__.AudioService }
];
